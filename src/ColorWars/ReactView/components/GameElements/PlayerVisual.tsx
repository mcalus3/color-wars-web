...
class PlayerComponent extends React.Component<Props, {images: {[key: string]: HTMLImageElement}}> {
  ...
  shouldComponentUpdate(nextProps: Readonly<Props>, nextState: object) {
    ...
    // I will check if this impedes performance:
    // if (PointsAreEqual(nextProps.player.coords, this.props.player.coords)){
    //   return false;
    // }
    return true;
  }
